...
// const WHATSAPP_NUMBER = "254700000000"; // no + sign for wa.me
...
//   // ✅ gallery state (no hardcoded image)
...
//       {/* ✅ Success toast */}
//       {toastOpen ? (
//         <div className="fixed bottom-5 right-5 z-50 w-[320px] rounded-2xl border border-emerald-200 bg-white p-4 shadow-lg">
...
//                 className="mt-3 rounded-xl bg-emerald-600 px-3 py-2 text-xs font-extrabold text-white hover:bg-emerald-700"
//               >
//                 View Cart →
//               </button>
//             </div>
...
//                     disabled={!hasImage}
//                     onClick={() =>
//                       setZoom((z) => clamp(Number((z - 0.2).toFixed(2)), 1, 3))
//                     }
...
//                 <select className="mt-3 w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm outline-none focus:border-gray-300">
//                   <option>Choose an option</option>
//                   <option>2 meters</option>
//                   <option>2.5 meters</option>
...
//                     −
//                   </button>
//                   <div className="w-14 text-center text-sm font-bold text-gray-900">
//                     {qty}
//                   </div>
//                   <button
//                     type="button"
