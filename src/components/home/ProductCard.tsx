...
// // ✅ icons (install if missing: npm i lucide-react)
...
//     >
//       {/* ✅ NO CARD: no bg-white, no shadow, no border wrapper */}
...
//           {/* Wishlist (no “card” bg, small professional icon button) */}
//           <button
//             type="button"
...
//         {/* Main info (flat text on page background) */}
//         <div className="pt-3">
...
//           {/* Hover-reveal section (flat, no borders/cards) */}
//           <div
//             className="
