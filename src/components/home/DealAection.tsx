...
// // DealsSection.tsx (dynamic)
// // Uses: GET /deals/latest via useGetLatestDealQuery
...
// const DealsSection = () => {
//   const { data, isLoading, isError, refetch } = useGetLatestDealQuery();
...
//       name: p.name,
//       price: kes(finalPrice({ price: p.price, deal_price: p.deal_price, discount_percentage: p.discount_percentage })),
//       inStock: (p.stock ?? 0) > 0,
//     })) ?? [];
...
//               {data?.title ?? "Latest Deals for This Month"}
//             </h2>
...
//         {/* Body */}
//         {isLoading ? (
//           <div className="mt-10 text-sm text-gray-600">Loading deals...</div>
//         ) : isError ? (
//           <div className="mt-10 rounded-2xl border border-rose-200 bg-rose-50 p-4 text-rose-800">
//             Failed to load deals.
//             <button
//               type="button"
//               onClick={() => refetch()}
//               className="ml-3 rounded-xl bg-rose-700 px-3 py-2 text-xs font-bold text-white"
//             >
//               Retry
//             </button>
//           </div>
//         ) : products.length === 0 ? (
//           <div className="mt-10 text-sm text-gray-600">No active deals right now.</div>
//         ) : (
